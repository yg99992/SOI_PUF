...
set rc [catch {
  ...
  add_files -quiet D:/FPGA_project/SOI_PUF_k2468/SOI_PUF_v1/SOI_PUF_v1.runs/synth_1/design_1_wrapper.dcp
...
set rc [catch {
  ...
  set src_rc [catch { 
    puts "source D:/FPGA_project/SOI_PUF_k2468/SOI_PUF_v1/drc.tcl"
    source D:/FPGA_project/SOI_PUF_k2468/SOI_PUF_v1/drc.tcl
  } _RESULT] 
  if {$src_rc} { 
    send_msg_id runtcl-1 error "$_RESULT"
    send_msg_id runtcl-2 error "sourcing script D:/FPGA_project/SOI_PUF_k2468/SOI_PUF_v1/drc.tcl failed"
    return -code error
  }
  set_property XPM_LIBRARIES {XPM_CDC XPM_FIFO XPM_MEMORY} [current_project]
